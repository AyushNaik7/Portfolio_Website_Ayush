...
export function CommandPalette() {
  ...
  // built from site content so the index stays in sync as projects evolve
  const commands = useMemo<Cmd[]>(() => {
    ...
    const links: Cmd[] = [
      ...
      { id: "instagram", group: "Links", label: "Instagram", keywords: "social content creator", run: () => ext(profile.socials.instagram) },
    ];
    const actions: Cmd[] = [
      {
        id: "copy-email",
    ...
    return [...nav, ...projectCmds, ...links, ...actions];
  }, [go, ext, close]);
