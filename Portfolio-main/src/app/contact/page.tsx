...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with Ayush Naik, an engineering student and software developer in Mumbai. Email, LinkedIn, or the contact form all reach me directly.",
