...
export const metadata: Metadata = {
  title: "Résumé",
  description:
    "Ayush Naik's resume: an engineering student and software developer with experience in client solutions, full-stack development, and business-tech bridge. View it here or download the PDF.",
...
const PAGES = ["/assets/resume-1.png.png", "/assets/resume-2.png"];
        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-5 font-mono text-sm">
            <a
              ...
              download="Ayush Naik - Resume.pdf"
              className={ctaClass}
            >
        ...
        <div className="mx-auto mt-14 flex max-w-[840px] flex-col gap-8">
          {PAGES.map((src, i) => (
            ...
            >
              <Image
                src={src}
                alt={`Ayush Naik resume, page ${i + 1}`}
                width={1428}
                height={1848}
