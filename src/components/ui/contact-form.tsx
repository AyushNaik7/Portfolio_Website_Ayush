...
export function ContactForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (!SERVICE_ID || !TEMPLATE_ID || !PUBLIC_KEY) {
      setStatus("error");
      setServerError("Email isn't wired up yet. Reach me at ayushnaik9898@gmail.com.");
      return;
    }
    ...
    try {
      ...
      await emailjs.send(
        ...
        TEMPLATE_ID,
        {
          ...
          to_email: "ayushnaik9898@gmail.com",
    ...
    <form onSubmit={onSubmit} className="space-y-5" noValidate>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Hey Ayush, we're hiring and your range stood out."
