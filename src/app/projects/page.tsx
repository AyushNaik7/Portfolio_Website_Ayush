...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "Projects Ayush Naik has built: instacollab.in B2B marketplace connecting 100+ brands and creators, client-focused web solutions, and IoT systems.",
    ...
    <div className="pt-32 pb-28">
      <Container>
        ...
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-bone-dim">
          Real applications and systems built end-to-end, from client-facing web solutions to IoT hardware integration. Each project solves actual problems and delivers measurable value.
        </p>
      </Container>
