...
export const metadata: Metadata = {
  ...
  description:
    "Research section for Ayush Naik - placeholder for future publications on software engineering and technology research.",
  alternates: { canonical: "/research" },
  openGraph: {
    type: "article",
    title: `${research.title} · Ayush Naik`,
    description:
      "Research section placeholder - ready for future publications and academic work.",
    url: "/research",
    images: [
      {
        url: "/og-image.png",
        width: 2560,
        height: 1280,
        alt: "Ayush Naik - Engineering Student and Software Developer",
      },
    ],
  },
  twitter: {
